// 2
// Two tests. The first sets the carry flag then does an LSL by 0, which should leave the carry flag set.
...
test1:
    ...
    # With the carry flag now set, shift left by 0, which should leave C set
    lsl r1, #0
...
test2:
    ...
    # With the carry flag now set, shift left by 0, which should leave C clear
    lsl r1, #0
